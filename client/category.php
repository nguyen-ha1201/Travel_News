...
<body>
	...
	<?php $id = $_GET['id'];
	$url = "http://localhost/Travel_News/webservices/api/get_all_category.php";
	...
	<div class="hero-wrap js-fullheight" style="background-image: url('images/HeaderImage.jpg');" data-stellar-background-ratio="0.5">
